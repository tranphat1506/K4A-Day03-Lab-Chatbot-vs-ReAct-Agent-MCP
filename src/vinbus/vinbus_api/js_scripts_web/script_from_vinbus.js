!function(e, t) {
    ...
    w.extend = w.fn.extend = function() {
        ...
        s--); s < l; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    i = e[t],
                    "__proto__" !== t && a !== i && (u && i && (w.isPlainObject(i) || (r = Array.isArray(i))) ? (n = a[t],
                    o = r && !Array.isArray(n) ? [] : r || w.isPlainObject(n) ? n : {},
                    r = !1,
                    a[t] = w.extend(u, o, i)) : void 0 !== i && (a[t] = i));
        return a
    }
    ,
    w.extend({
    ...
    var x = function(e) {
        var t, n, i, r, o, a, s, l, u, c, f, d, h, p, g, m, v, y, b, _ = "sizzle" + 1 * new Date, w = e.document, E = 0, x = 0, T = le(), C = le(), S = le(), k = le(), D = function(e, t) {
            return e === t && (f = !0),
            0
        }, N = {}.hasOwnProperty, A = [], j = A.pop, O = A.push, L = A.push, I = A.slice, q = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, P = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", R = "(?:\\\\[\\da-fA-F]{1,6}" + H + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", F = "\\[" + H + "*(" + R + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + H + "*\\]", M = ":(" + R + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)", B = new RegExp(H + "+","g"), W = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$","g"), U = new RegExp("^" + H + "*," + H + "*"), Q = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), $ = new RegExp(H + "|>"), z = new RegExp(M), V = new RegExp("^" + R + "$"), X = {
            ID: new RegExp("^#(" + R + ")"),
            CLASS: new RegExp("^\\.(" + R + ")"),
            TAG: new RegExp("^(" + R + "|[*])"),
            ATTR: new RegExp("^" + F),
        ...
        }, Y = /HTML$/i, K = /^(?:input|select|textarea|button)$/i, G = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + H + "?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
        ...
        function se(e, t, i, r) {
            ...
            g)) {
                ...
                if (n.qsa && !k[e + " "] && (!m || !m.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    y = t,
                    1 === w && ($.test(e) || Q.test(e))) {
                        for ((y = ee.test(e) && ve(t.parentNode) || t) === t && n.scope || ((c = t.getAttribute("id")) ? c = c.replace(ie, re) : t.setAttribute("id", c = _)),
                        s = (p = a(e)).length; s--; )
        ...
        d = se.setDocument = function(e) {
            ...
            : function(e, t) {
                ...
                if (!r || !o)
                    return e == h ? -1 : t == h ? 1 : r ? -1 : o ? 1 : c ? q(c, e) - q(c, t) : 0;
                if (r === o)
                    return de(e, t);
        ...
        (i = se.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, i, r) {
                    ...
                    : function(t, n, l) {
                        var u, c, f, d, h, p, g = o !== a ? "nextSibling" : "previousSibling", m = t.parentNode, v = s && t.nodeName.toLowerCase(), y = !l && !s, b = !1;
                        if (m) {
                            if (o) {
                                for (; g; ) {
                                    for (d = t; d = d[g]; )
                            ...
                            !1 === b)
                                for (; (d = ++h && d && d[g] || (b = h = 0) || p.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && ((c = (f = d[_] || (d[_] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [E, b]),
                                d !== t)); )
                                    ;
            ...
            ue(function(o, a, s, l) {
                var u, c, f, d = [], h = [], p = a.length, g = o || function(e, t, n) {
                    for (var i = 0, r = t.length; i < r; i++)
                        se(e, t[i], n);
                    return n
                }(t || "*", s.nodeType ? [s] : s, []), m = !e || !o && t ? g : Ee(g, d, e, s, l), v = n ? r || (o ? e : p || i) ? [] : a : m;
                if (n && n(m, v, s, l),
                i)
                    for (u = Ee(v, h),
                    i(u, [], s, l),
                ...
                if (o) {
                    if (r || e) {
                        ...
                        for (c = v.length; c--; )
                            (f = v[c]) && -1 < (u = r ? q(o, f) : d[c]) && (o[u] = !(a[u] = f))
                    }
                } else
                    v = Ee(v === a ? v.splice(p, v.length) : v),
                    r ? r(null, a, v, l) : L.apply(a, v)
            })
        }
        function Te(e) {
        ...
        s = se.compile = function(e, t) {
            ...
            if (!m) {
                ...
                c = function(e, t, n, a, c) {
                    var f, p, m, v = 0, y = "0", b = e && [], _ = [], w = u, x = e || l && i.find.TAG("*", c), T = E += null == w ? 1 : Math.random() || .1, C = x.length;
                    ...
                    s && y !== v) {
                        ...
                        L.apply(a, _),
                        c && !e && 0 < _.length && 1 < v + o.length && se.uniqueSort(a)
                    }
                    return c && (E = T,
                    u = w),
                    b
        ...
        l = se.select = function(e, t, n, r) {
            ...
            1 === h.length) {
                ...
                for (o = X.needsContext.test(e) ? 0 : l.length; o-- && !i.relative[c = (u = l[o]).type]; )
            ...
            return (d || s(e, h))(r, t, !g, n, !t || ee.test(e) && ve(t.parentNode) || t),
            n
        }
        ,
    ...
    w.Callbacks = function(e) {
        ...
        t) : w.extend({}, e);
        var n, i, r, o, a = [], s = [], l = -1, u = function() {
            for (o = o || e.once,
            r = n = !0; s.length; l = -1)
            ...
            add: function() {
                ...
                function t(n) {
                    w.each(n, function(n, i) {
                        p(i) ? e.unique && c.has(i) || a.push(i) : i && i.length && "string" !== b(i) && t(i)
                    })
                }(arguments),
                i && !n && u()),
                this
                            ...
                            var s = this
                              ...
                              , u = function() {
                                ...
                                if (!(t < o)) {
                                    ...
                                    p(u = e && ("object" == typeof e || "function" == typeof e) && e.then) ? r ? u.call(e, a(o, n, P, r), a(o, n, H, r)) : (o++,
                                    u.call(e, a(o, n, P, r), a(o, n, H, r), a(o, n, P, n.notifyWith))) : (i !== P && (s = void 0,
                                    l = [e]),
                                    (r || n.resolveWith)(s, l))
                                }
                            }
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                ...
                1 === o.nodeType && !Y.get(o, "hasDataAttrs"))) {
                    for (n = a.length; n--; )
                        a[n] && 0 === (i = a[n].name).indexOf("data-") && (i = z(i.slice(5)),
                        Z(o, i, r[i]));
    ...
    w.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = void 0),
            e = e || "fx"; a--; )
                (n = Y.get(o[a], e + "queueHooks")) && n.empty && (i++,
                n.empty.add(s));
            return s(),
            r.promise(t)
        }
    ...
    function ue(e, t) {
        for (var n, i, r, o, a, s, l, u = [], c = 0, f = e.length; c < f; c++)
            ...
            u[c] || (i.style.display = "")),
            "" === i.style.display && ae(i) && (u[c] = (l = a = o = void 0,
            a = (r = i).ownerDocument,
            (l = le[s = r.nodeName]) || (o = a.body.appendChild(a.createElement(s)),
            l = w.css(o, "display"),
    ...
    w.event = {
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(q) || [""]).length; u--; )
                    ...
                    h) {
                        ...
                        a = o = d.length; o--; )
                            c = d[o],
                            !r && g !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (d.splice(o, 1),
        ...
        dispatch: function(e) {
            var t, n, i, r, o, a, s = new Array(arguments.length), l = w.event.fix(e), u = (Y.get(this, "events") || Object.create(null))[l.type] || [], c = w.event.special[l.type] || {};
            for (s[0] = l,
            ...
            !c.preDispatch || !1 !== c.preDispatch.call(this, l)) {
                ...
                t = 0; (r = a[t++]) && !l.isPropagationStopped(); )
                    ...
                    n = 0; (o = r.handlers[n++]) && !l.isImmediatePropagationStopped(); )
                        ...
                        l.data = o.data,
                        void 0 !== (i = ((w.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, s)) && !1 === (l.result = i) && (l.preventDefault(),
                        l.stopPropagation()));
            ...
            if (l && u.nodeType && !("click" === e.type && 1 <= e.button))
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                        ...
                        a = {},
                        n = 0; n < l; n++)
                            void 0 === a[r = (i = t[n]).selector + " "] && (a[r] = i.needsContext ? -1 < w(r, this).index(u) : w.find(r, this, null, [u]).length),
                            a[r] && o.push(i);
                        o.length && s.push({
                            elem: u,
                            handlers: o
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && k(t, "input") && ke(t, "click", xe),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && k(t, "input") && ke(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    function qe(e, t, n, i) {
        t = o(t);
        var r, a, s, l, u, c, f = 0, d = e.length, g = d - 1, m = t[0], v = p(m);
        ...
        if (d && (a = (r = be(t, e[0].ownerDocument, !1, e, i)).firstChild,
    ...
    function Be(e, t, n) {
        ...
        return (n = n || Re(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || re(e) || (a = w.style(e, t)),
        !h.pixelBoxStyles() && He.test(a) && Me.test(t) && (i = s.width,
        r = s.minWidth,
        o = s.maxWidth,
    ...
    function Je(e, t, n, i, r, o) {
        ...
        for (; a < 4; a += 2)
            ...
            i ? ("content" === n && (l -= w.css(e, "padding" + ne[a], !0, r)),
    ...
    function Ze(e, t, n) {
        ...
        return (!h.boxSizingReliable() && r || !h.reliableTrDimensions() && k(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === w.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === w.css(e, "boxSizing", !1, i),
        (o = s in e) && (a = e[s])),
    ...
    w.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                o = "number"),
                null != n && n == n && ("number" !== o || l || (n += r && r[3] || (w.cssNumber[s] ? "" : "px")),
    ...
    w.each(["height", "width"], function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return !Ve.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ze(e, t, i) : Fe(e, Ye, function() {
                        return Ze(e, t, i)
                    })
            },
            set: function(e, n, i) {
                var r, o = Re(e), a = !h.scrollboxSize() && "absolute" === o.position, s = (a || i) && "border-box" === w.css(e, "boxSizing", !1, o), l = i ? Je(e, t, i, s, o) : 0;
    ...
    w.cssHooks.marginLeft = We(h.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(Be(e, "marginLeft")) || e.getBoundingClientRect().left - Fe(e, {
                marginLeft: 0
            }, function() {
    ...
    function ft(e, t, n) {
        var i, r, o = 0, a = ft.prefilters.length, s = w.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var t = tt || lt(), n = Math.max(0, u.startTime + u.duration - t), i = 1 - (n / u.duration || 0), o = 0, a = u.tweens.length; o < a; o++)
                u.tweens[o].run(i);
    ...
    w.Animation = w.extend(ft, {
        ...
        prefilters: [function(e, t, n) {
            var i, r, o, a, s, l, u, c, f = "width" in t || "height" in t, d = this, h = {}, p = e.style, g = e.nodeType && ae(e), m = Y.get(e, "fxshow");
    ...
    w.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = Y.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = w.timers, a = i ? i.length : 0;
                for (n.finish = !0,
                w.queue(this, e, []),
    ...
    w.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? w.prop(e, t, n) : (1 === o && w.isXMLDoc(e) || (r = w.attrHooks[t.toLowerCase()] || (w.expr.match.bool.test(t) ? dt : void 0)),
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : p(e) ? this.each(function(n) {
                ...
                if (i)
                    ...
                    void 0 !== e && "boolean" !== n || ((t = vt(this)) && Y.set(this, "__className__", t),
    ...
    w.extend(w.event, {
        trigger: function(t, n, i, r) {
            var o, a, s, l, u, f, d, h, v = [i || m], y = c.call(t, "type") ? t.type : t, b = c.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = h = s = i = i || m,
            3 !== i.nodeType && 8 !== i.nodeType && !_t.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(),
            b.sort()),
            u = y.indexOf(":") < 0 && "on" + y,
            ...
            r || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!r && !d.noBubble && !g(i)) {
                    for (_t.test((l = d.delegateType || y) + y) || (a = a.parentNode); a; a = a.parentNode)
                        v.push(a),
                        s = a;
                ...
                for (o = 0; (a = v[o++]) && !t.isPropagationStopped(); )
                    ...
                    (f = u && a[u]) && f.apply && V(a) && (t.result = f.apply(a, n),
                    !1 === t.result && t.preventDefault());
                return t.type = y,
                r || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(v.pop(), n) || !V(i) || u && p(i[y]) && !g(i) && ((s = i[u]) && (i[u] = null),
                w.event.triggered = y,
    ...
    h.focusin || w.each({
        ...
        w.event.special[t] = {
            ...
            teardown: function() {
                var i = this.ownerDocument || this.document || this
                  , r = Y.access(i, t) - 1;
                r ? Y.access(i, t, r) : (i.removeEventListener(e, n, !0),
                Y.remove(i, t))
            }
        }
    });
    ...
    w.extend({
        ...
        ajax: function(t, n) {
            "object" == typeof t && (n = t,
            t = void 0);
            var i, r, o, a, s, l, u, c, f, d, h = w.ajaxSetup({}, n = n || {}), p = h.context || h, g = h.context && (p.nodeType || p.jquery) ? w(p) : w.event, v = w.Deferred(), y = w.Callbacks("once memory"), b = h.statusCode || {}, _ = {}, E = {}, x = "canceled", T = {
                readyState: 0,
            ...
            h.url = r + d),
            h.ifModified && (w.lastModified[r] && T.setRequestHeader("If-Modified-Since", w.lastModified[r]),
            ...
            function C(t, n, a, l) {
                ...
                f ? (h.ifModified && ((E = T.getResponseHeader("Last-Modified")) && (w.lastModified[r] = E),
    ...
    h.createHTMLDocument = (($t = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    w.offset = {
        setOffset: function(e, t, n) {
            var i, r, o, a, s, l, u = w.css(e, "position"), c = w(e), f = {};
            "static" === u && (e.style.position = "relative"),
            s = c.offset(),
            o = w.css(e, "top"),
            l = w.css(e, "left"),
            ("absolute" === u || "fixed" === u) && -1 < (o + l).indexOf("auto") ? (a = (i = c.position()).top,
        ...
        w.each({
            ...
            w.fn[i] = function(r, o) {
                ...
                return W(this, function(t, n, r) {
                    ...
                    Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === r ? w.css(t, n, s) : w.style(t, n, r, s)
                }, t, a ? r : void 0, a)
            }
        })
    }),
...
function(e, t) {
    ...
    function m(e, n) {
        ...
        return (a && !r ? n.contains(f) : n === f && "BODY" !== f.nodeName) && (v = c(v, n)),
        v
    }
    function v(e) {
    ...
    function D(t, n, i) {
        return (void 0 === i ? t : t.slice(0, function(e, t, n) {
            ...
            t.enabled && e(i) && (n.offsets.popper = p(n.offsets.popper),
    ...
    function q(e, t, n, r) {
        ...
        var o = i(e);
        return I(o, "scroll", n.updateBound, n.scrollParents),
        n.scrollElement = o,
        n.eventsEnabled = !0,
        n
    }
    function P() {
        this.state.eventsEnabled || (this.state = q(this.reference, 0, this.state, this.scheduleUpdate))
    }
    function H() {
        this.state.eventsEnabled && (cancelAnimationFrame(this.scheduleUpdate),
        this.state = function(e, t) {
            return L(e).removeEventListener("resize", t.updateBound),
    ...
    : function(e) {
      ...
      , re = function() {
        function t(n, i) {
            ...
            Object.keys(ee({}, t.Defaults.modifiers, o.modifiers)).forEach(function(e) {
                r.options.modifiers[e] = ee({}, t.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {})
            }),
    ...
    return re.Utils = ("undefined" == typeof window ? global : window).PopperUtils,
    re.placements = ne,
    re.Defaults = {
        placement: "bottom",
        positionFixed: !1,
        ...
        modifiers: {
            ...
            offset: {
                ...
                enabled: !0,
                fn: function(e, t) {
                    var n, i = t.offset, r = e.offsets, o = r.popper, a = r.reference, s = e.placement.split("-")[0];
                    ...
                    "left" === s ? (o.top += n[0],
                    o.left -= n[1]) : "right" === s ? (o.top += n[0],
                    o.left += n[1]) : "top" === s ? (o.left += n[0],
                    o.top -= n[1]) : "bottom" === s && (o.left += n[0],
                    o.top += n[1]),
                    e.popper = o,
                    e
                },
                ...
                fn: function(e, t) {
                    ...
                    var c = e.offsets.popper
                      , f = {
                        primary: function(e) {
                            var n = c[e];
                            return c[e] < u[e] && !t.escapeWithReference && (n = $(c[e], u[e])),
                            Z({}, e, n)
                        },
                        secondary: function(e) {
                            var n = "right" === e ? "left" : "top"
                              , i = c[n];
                            return c[e] > u[e] && !t.escapeWithReference && (i = W(c[n], u[e] - ("right" === e ? c.width : c.height))),
                            Z({}, n, i)
                        }
                    };
            ...
            arrow: {
                ...
                fn: function(e, n) {
                    ...
                    return w = $(W(s[c] - m, w), 0),
                    e.arrowElement = r,
                    e.offsets.arrow = (Z(i = {}, d, Q(w)),
                    Z(i, h, ""),
                    i),
                    e
                },
                ...
                fn: function(e, t) {
                    ...
                    return a.forEach(function(s, l) {
                        ...
                        var u = e.offsets.popper
                          ...
                          , b = !!t.flipVariations && (y && "start" === o && h || y && "end" === o && p || !y && "start" === o && g || !y && "end" === o && m) || !!t.flipVariationsByContent && (y && "start" === o && p || y && "end" === o && h || !y && "start" === o && m || !y && "end" === o && g);
                        (d || v || b) && (e.flipped = !0,
                        (d || v) && (i = a[l + 1]),
                        b && (o = function(e) {
                        ...
                        e.placement = i + (o ? "-" + o : ""),
                        e.offsets.popper = ee({}, e.offsets.popper, S(e.instance.popper, e.offsets.reference, e.placement)),
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, l, u = void 0 === o ? t.gpuAcceleration : o, c = a(e.instance.popper), f = g(c), d = {
                        position: r.position
                    }, h = function(e, t) {
                        var n = e.offsets
                          , i = n.popper
                          ...
                          , f = t ? r : o;
                        return {
                            left: c(1 == a % 2 && 1 == s % 2 && !u && t ? i.left - 1 : i.left),
                            top: f(i.top),
                            bottom: f(i.bottom),
                            right: c(i.right)
                        }
                    }(e, 2 > window.devicePixelRatio || !te), p = "bottom" === n ? "top" : "bottom", m = "right" === i ? "left" : "right", v = j("transform");
                    if (l = "bottom" == p ? "HTML" === c.nodeName ? -c.clientHeight + h.bottom : -f.height + h.bottom : h.top,
                    s = "right" == m ? "HTML" === c.nodeName ? -c.clientWidth + h.right : -f.width + h.right : h.left,
                    u && v)
...
function(e, t) {
    ...
    var c = "alert"
      ...
      , d = function() {
        ...
        t._triggerCloseEvent = function(e) {
            ...
            return r.default(e).trigger(t),
            t
        }
        ,
        t._removeElement = function(e) {
            var t = this;
            if (r.default(e).removeClass("show"),
    ...
    var g = "carousel"
      ...
      , _ = function() {
        ...
        t._slide = function(e, t) {
            var n, i, o, a = this, s = this._element.querySelector(".active.carousel-item"), l = this._getItemIndex(s), c = t || s && this._getItemByDirection(e, s), f = this._getItemIndex(c), d = Boolean(this._interval);
            ...
            c && r.default(c).hasClass("active"))
                ...
                if (r.default(this._element).hasClass("slide")) {
                    ...
                    r.default(s).one(u.TRANSITION_END, function() {
                        r.default(c).removeClass(n + " " + i).addClass("active"),
    ...
    r.default(document).on("click.bs.carousel.data-api", "[data-slide], [data-slide-to]", _._dataApiClickHandler),
      ...
      , C = function() {
        ...
        t.show = function() {
            ...
            t && (n = r.default(t).not(this._selector).data("bs.collapse")) && n._isTransitioning))) {
                ...
                !o.isDefaultPrevented()) {
                    t && (e._jQueryInterface.call(r.default(t).not(this._selector), "hide"),
        ...
        t.hide = function() {
            ...
            if (!this._isTransitioning && r.default(this._element).hasClass("show")) {
                ...
                if (r.default(this._element).trigger(t),
        ...
        ,
        t._getConfig = function(e) {
            return (e = l({}, x, e)).toggle = Boolean(e.toggle),
        ...
        e._jQueryInterface = function(t) {
            return this.each(function() {
                ...
                if (!i && o.toggle && "string" == typeof t && /show|hide/.test(t) && (o.toggle = !1),
                i || (i = new e(this,o),
      ...
      , j = function() {
        ...
        t._getPlacement = function() {
            var e = r.default(this._element.parentNode)
              , t = "bottom-start";
            return e.hasClass("dropup") ? t = r.default(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : r.default(this._menu).hasClass("dropdown-menu-right") && (t = "bottom-end"),
            t
        }
        ,
        ...
        e._dataApiKeydownHandler = function(t) {
            if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || r.default(t.target).closest(".dropdown-menu").length) : !D.test(t.which)) && !this.disabled && !r.default(this).hasClass("disabled")) {
                ...
                if (i || 27 !== t.which) {
                    ...
                    !i || 27 === t.which || 32 === t.which)
                        return 27 === t.which && r.default(n.querySelector('[data-toggle="dropdown"]')).trigger("focus"),
    ...
    r.default(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', j._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", j._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", j._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        ...
        t._triggerBackdropTransition = function() {
            ...
            !t.isDefaultPrevented()) {
                ...
                r.default(this._element).one(u.TRANSITION_END, function() {
                    ...
                    n || r.default(e._element).one(u.TRANSITION_END, function() {
        ...
        for (var i = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), o = [].slice.call(i.body.querySelectorAll("*")), a = function(e, n) {
            ...
            s.forEach(function(e) {
                (function(e, t) {
                    ...
                    if (-1 !== t.indexOf(n))
                        return -1 === P.indexOf(n) || Boolean(e.nodeValue.match(H) || e.nodeValue.match(R));
    ...
    var M = "tooltip"
      ...
      , X = function() {
        ...
        t.hide = function(e) {
            ...
            !i.isDefaultPrevented()) {
                if (r.default(n).removeClass("show"),
        ...
        t.setElementContent = function(e, t) {
            ...
            e.html(t)) : e.text(t) : this.config.html ? r.default(t).parent().is(e) || e.empty().append(t) : e.text(r.default(t).text())
        }
        ,
        t.getTitle = function() {
        ...
        t._enter = function(e, t) {
            ...
            (t = t || r.default(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
        ...
        t._fixTransition = function() {
            ...
            null === e.getAttribute("x-placement") && (r.default(e).removeClass("fade"),
        ...
        e._jQueryInterface = function(t) {
            return this.each(function() {
                var n = r.default(this)
                  , i = n.data("bs.tooltip")
                  , o = "object" == typeof t && t;
                if ((i || !/dispose|hide/.test(t)) && (i || (i = new e(this,o),
                n.data("bs.tooltip", i)),
                "string" == typeof t)) {
                    if (void 0 === i[t])
                        throw new TypeError('No method named "' + t + '"');
      ...
      , ae = function() {
        ...
        return t.refresh = function() {
            ...
            [].slice.call(document.querySelectorAll(this._selector)).map(function(e) {
                var i, o = u.getSelectorFromElement(e);
        ...
        t._getConfig = function(e) {
            ...
            return u.typeCheckConfig(ne, e, oe),
            e
        }
        ,
      ...
      , le = function() {
        ...
        return t.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && r.default(this._element).hasClass("active") || r.default(this._element).hasClass("disabled"))) {
                var t, n, i = r.default(this._element).closest(".nav, .list-group")[0], o = u.getSelectorFromElement(this._element);
                if (i) {
        ...
        t._transitionComplete = function(e, t, n) {
            ...
            if (r.default(e).addClass("active"),
    ...
    var ue = r.default.fn.toast
      ...
      , de = function() {
        ...
        ,
        t._getConfig = function(e) {
            return e = l({}, fe, r.default(this._element).data(), "object" == typeof e && e ? e : {}),
